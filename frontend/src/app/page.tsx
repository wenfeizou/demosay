      ...
      <div className="bg-white pb-6 sm:pb-8 lg:pb-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
            <div className="flex flex-col justify-center sm:text-center lg:pb-12 lg:text-left xl:w-5/12 xl:py-24">
              <Link href="/plan" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                  <span className="text-xs bg-purple-500 rounded-full text-white px-4 py-1.5 mr-3">Hot</span> <span className="text-sm font-medium">
                    限时优惠：30 天免费发布课程包！
                  </span>
              ...
              <p className="mb-3 leading-relaxed text-gray-500 md:mb-6 lg:w-4/5 xl:text-lg">
        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
            <div className="flex gap-4 md:gap-6">
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold md:text-xl">游戏化学习方式</h3>
            ...
            <div className="flex gap-4 md:gap-6">
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold md:text-xl">内容格式丰富</h3>
                <p className="mb-2 text-gray-500">
                  场景演示 (Demo) 支持文本、图片、视频
                </p>
                <a
                  className="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700"
                  href="#"
            ...
            <div className="flex gap-4 md:gap-6">
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold md:text-xl">新手友好</h3>
                <p className="mb-2 text-gray-500">
                  就是针对新手，再也不焦虑了
                </p>
                <a
            ...
            <div className="flex gap-4 md:gap-6">
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold md:text-xl">防作弊</h3>
                <p className="mb-2 text-gray-500">
                  必须手动输入答案
                </p>
                <a
            ...
            <div className="flex gap-4 md:gap-6">
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold md:text-xl">动态题库,动态答案</h3>
                <p className="mb-2 text-gray-500">
                  同一道题，随机变化答案
                </p>
                <a
            ...
            <div className="flex gap-4 md:gap-6">
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold md:text-xl">需要用户观看长视频？</h3>
                <p className="mb-2 text-gray-500">
                  视频藏有彩蛋，神秘数字，用户必须 Say 正确
                </p>
                <a
                  className="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700"
                  href="#"
        ...
        <div className="mx-auto max-w-screen-xl px-4 md:px-8">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-0 md:divide-x">
            <div className="flex flex-col items-center md:p-4">
              ...
              <div className="text-sm font-semibold sm:text-base">课程包</div>
            </div>
            <div className="flex flex-col items-center md:p-4">
              <div className="text-xl font-bold text-indigo-500 sm:text-2xl md:text-3xl">
                500+
              </div>
              <div className="text-sm font-semibold sm:text-base">发布者</div>
            </div>
            <div className="flex flex-col items-center md:p-4">
              <div className="text-xl font-bold text-indigo-500 sm:text-2xl md:text-3xl">
                1,000,000+
              </div>
              <div className="text-sm font-semibold sm:text-base">用户</div>
            </div>
            <div className="flex flex-col items-center md:p-4">
              <div className="text-xl font-bold text-indigo-500 sm:text-2xl md:text-3xl">
                100,000,000,000+
              </div>
              <div className="text-sm font-semibold sm:text-base">Say 的次数</div>
            </div>
          </div>
        </div>
      </div>
