...
const features = [
  {
    title: "游戏化的交互方式",
    description: "独特、简单、好玩",
  },
  {
    title: "内容格式丰富",
    description: "场景演示 (Demo) 支持文本、图片、视频",
  },
  {
    title: "新手友好",
    description: "就是针对新手，再也不焦虑了",
  },
  {
    title: "防作弊",
    description: "必须手动输入答案",
  },
  {
    title: "动态答案",
    description: "同一演示，随机变化答案",
  },
  {
    title: "需要用户观看长视频？",
    description: "视频藏有彩蛋，神秘数字，用户必须 Say 正确",
  },
];

const stats = [
  { label: "Demo Packages", value: "100,000+" },
  { label: "发布者", value: "500+" },
  { label: "用户", value: "1,000,000+" },
  { label: "Say 的次数", value: "100,000,000,000+" },
];
  ...
  return (
    <div>
      <div className="pb-6 sm:pb-8 lg:pb-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
            <div className="flex flex-col gap-10 justify-center sm:text-center lg:pb-12 lg:text-left xl:w-5/12 xl:py-24">
              <AppLink
                className="mb-7 inline-flex items-center justify-between rounded-full border border-cyan-400/20 bg-white/8 px-1 py-1 pr-4 text-sm text-cyan-100 hover:bg-white/12"
                href="#"
              >
                <span className="mr-3 rounded-full bg-cyan-400 px-4 py-1.5 text-xs font-semibold text-slate-950">
                  Hot
                </span>
              ...
              <p className="mb-4 font-semibold text-cyan-300 md:mb-6 md:text-lg xl:text-xl">
                DemoSay
              </p>
              ...
              <p className="mb-8 leading-relaxed text-slate-300 md:mb-12 lg:w-4/5 xl:text-lg">
                DemoSay 有效促进了像 EVE Frontier 游戏、Sui 链社区等的传播、拉新和留存。
              </p>
              <div className="flex flex-col gap-2.5 sm:flex-row sm:justify-center lg:justify-start">
                <AppLink
                  className={`${primaryButtonClassName} px-8 py-3 text-center md:text-base`}
                  href="/packages"
                >
                  立即使用
                </AppLink>
                <AppLink
                  className={`${secondaryButtonClassName} px-8 py-3 text-center md:text-base`}
                  href="#"
                >
                  了解更多
                </AppLink>
            ...
            <div className="h-48 overflow-hidden rounded-3xl border border-white/10 bg-white/8 shadow-2xl shadow-cyan-950/20 lg:h-auto xl:w-5/12">
              <img
                alt="DemoSay hero"
      ...
      <div className="py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className="flex flex-col gap-10 items-center pb-16 mb-10 md:mb-16">
            ...
            <p className="mx-auto max-w-screen-md text-center text-slate-300 md:text-lg">
              依托 AI 和大数据技术，提供个性化的学习管理
            </p>
          </div>
          <div className="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
            {features.map((feature) => (
              <div key={feature.title} className={featureCardClassName}>
                ...
                <div>
                  ...
                  <p className="mb-2 text-slate-300">{feature.description}</p>
                  <AppLink
      ...
      <div className="py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className="flex flex-col gap-10 items-center pb-16 mb-10 md:mb-16">
            <h2 className="mb-4 text-center text-2xl font-bold text-slate-50 md:mb-8 lg:text-3xl">
              被客户信赖
            </h2>
          </div>
          <div className={`${panelClassName} grid grid-cols-2 gap-6 sm:h-40 sm:content-evenly md:grid-cols-4`}>
            ...
            <div className="flex justify-center text-slate-400">
              ...
              >
                ...
                <rect height="5" width="24" y="26" />
                <rect height="5" width="15" x="9" y="17" />
              </svg>
            </div>
            <div className="flex justify-center text-slate-400">
              <svg
      ...
      <div className="py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <div className={`${panelClassName} grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-0 md:divide-x md:divide-white/10`}>
            {stats.map((item) => (
              <div key={item.label} className="flex flex-col items-center md:p-4">
                <div className="text-xl font-bold text-cyan-300 sm:text-2xl md:text-3xl">
                  {item.value}
                </div>
      ...
      <div className="py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-xl px-4 md:px-8">
          <h2 className="mb-8 text-center text-2xl font-bold text-slate-50 md:mb-12 lg:text-3xl">
            用户说
          </h2>
          <div className="grid gap-y-10 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-3 lg:divide-x lg:divide-white/10">
            {testimonials.map((item) => (
              <div
                key={item.name}
                className="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8"
              >
                <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-6 text-center text-slate-300 shadow-lg shadow-cyan-950/10">
                  {item.quote}
                </div>
                <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
                  <div className="h-12 w-12 overflow-hidden rounded-full border border-white/10 bg-slate-900 shadow-lg md:h-14 md:w-14">
                    <img
                      alt={item.name}
                      className="h-full w-full object-cover object-center"
                      loading="lazy"
                  ...
                  <div>
                    <div className="text-center text-sm font-bold text-cyan-300 sm:text-left md:text-base">
                      {item.name}
                    </div>
                    <p className="text-center text-sm text-slate-400 sm:text-left md:text-sm">
                      {item.role}
                    </p>
                  </div>
                </div>
      ...
      <div className="py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className={`${panelClassName} flex flex-col items-center p-4 sm:p-8`}>
            <div className="mb-4 sm:mb-8">
              <h2 className="text-center text-xl font-bold text-cyan-300 sm:text-2xl lg:text-3xl">
                订阅产品更新
              </h2>
            ...
            >
              <input
                className={`${textInputClassName} w-full flex-1`}
                placeholder="电子邮箱"
              />
              <button className={`${primaryButtonClassName} px-8 py-2 md:text-base`}>
                提交登记
              </button>
            </form>
            <p className="text-center text-xs text-slate-400">
              提交登记表明您已知晓并同意{" "}
              <AppLink
                className="underline transition duration-100 hover:text-cyan-300 active:text-cyan-200"
                href="#"
              >
                服务协议
              </AppLink>{" "}
